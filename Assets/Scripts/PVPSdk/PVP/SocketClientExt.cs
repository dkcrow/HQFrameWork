...
{
	internal static class SocketClientExt
	{
		...
		internal static byte[] CheckBigEndian(this byte[] array){
		...
		internal static byte [] ReadBytes (this System.IO.Stream stream, byte [] buffer, int offset, int length)
		{
